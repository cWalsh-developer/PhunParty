...
def create_player_route(player: Player, db: Session = Depends(get_db)):
    ...
    """
    game = create_player(db, player.player_name, player.player_email, player.player_mobile)
    return game
...
def update_player_score_route(player_id: str, score: int, db: Session = Depends(get_db)):
    """
...
def update_player_name_route(player_id: str, player_name: str, db: Session = Depends(get_db)):
    """
...
def update_player_game_code_route(player_id: str, game_code: str, db: Session = Depends(get_db)):
    """
